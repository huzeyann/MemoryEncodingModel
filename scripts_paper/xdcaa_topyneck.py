...
if __name__ == "__main__":
    ...
    cfg.RESULTS_DIR = "/nfscc/alg23/xdcaa/"
    
    tune_config = {
        "REGULARIZER.LAYER": tune.grid_search([3e-3, 1e-3, 3e-4, 1e-4, 3e-5]),  # inspect layer selector histogram and pick the best, manually
    }
    name = f"topyneck"
