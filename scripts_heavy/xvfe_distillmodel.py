...
if __name__ == "__main__":
    ...
    cfg.RESULTS_DIR = "/nfscc/alg23/xvfe/"
    ...
    tune_config = {
        ...
        "OPTIMIZER.LR": tune.grid_search([1e-4, 3e-4, 6e-4, 1e-3]),
    }
    name = f"fnb"
    run_ray(
        name,
    ...
    #         "EXPERIMENTAL.BEHV_SELECTION": np.arange(8, 21).tolist(),
    ...
    #         "EXPERIMENTAL.USE_BHV_PASSTHROUGH": True,
    #         "EXPERIMENTAL.USE_PREV_FRAME": False,
    #         "EXPERIMENTAL.BEHV_SELECTION": np.arange(0, 6).tolist(),
    #         "MODEL.COND.IN_DIM": 6,
    #     }, # behavior only
    # ]
