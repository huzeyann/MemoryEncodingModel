...
if __name__ == "__main__":
    ...
    cfg = load_from_yaml("/workspace/configs/xvba.yaml")
    cfg.RESULTS_DIR = "/nfscc/alg23/xvbc/"
    ...
    # tune_config = {
    #     "DATASET.ROIS": tune.grid_search([[f'r_2_{i}'] for i in range(1, 10)]),
    # }
    # name = f"R2"
    # run_ray(name, cfg, tune_config, args.rm, args.progress, args.verbose, 1, t, args.topyneck_path)

    # tune_config = {
    #     "DATASET.ROIS": tune.grid_search([[f'r_3_{i}'] for i in range(1, 10)]),
    # }
    # name = f"R3"
    # run_ray(name, cfg, tune_config, args.rm, args.progress, args.verbose, 1, t, args.topyneck_path)
