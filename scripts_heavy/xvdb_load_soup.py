...
def get_parser():
    ...
    parser.add_argument(
        "--dark_name", type=str, default="xvdb", help="dark name"
    )
    parser.add_argument(
        "--save_dir", type=str, default="/nfscc/alg23/xvdb/predict", help="save dir"
    )
    parser.add_argument(
        "--exp_dir", type=str, default="/nfscc/alg23/xvbc/", help="exp dir"
    )
    ...
    parser.add_argument("--skip_aw", action="store_true", help="skip_aw")
    return parser
