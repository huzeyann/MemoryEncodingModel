...
if __name__ == "__main__":
    ...
    cfg.RESULTS_DIR = "/nfscc/ray_results/behavior_mkii"
    ...
    tune_config = {
        "DATASET.SUBJECT_LIST": tune.grid_search([["subj01"], ['subj01', 'subj02', 'subj03', 'subj04', 'subj05', 'subj06', 'subj07', 'subj08']]),
        "DATAMODULE.BATCH_SIZE": tune.sample_from(lambda spec: len(spec.config['DATASET.SUBJECT_LIST']) * 16),
