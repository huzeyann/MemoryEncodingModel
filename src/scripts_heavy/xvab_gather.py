...
def get_parser():
    ...
    parser.add_argument("--save_dir", type=str, default="/nfscc/alg23/xvab/mem", help="save dir")
    parser.add_argument("--exp_dir", type=str, default="/nfscc/alg23/xvaa/topyneck", help="exp dir")
    return parser
